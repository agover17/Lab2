...
public class GamePlay {
	...
	public GamePlay(Rule rle) {
		...
		/*
		 * this.NbrOfJokers = rle.GetNumberOfJokers(); this.WildCards =
		 * rle.GetRuleCards();
		 */
	...
	/*
	 * public int GetNumberOfJokers() { return NbrOfJokers; }
	 * 
	 * public ArrayList<Card> GetWildCards() { return this.WildCards; }
	 */
