...
public final class Card {
	...
	/*
	 * @XmlElement private boolean Wild = false;
	 * 
	 * @XmlElement private String CardImg;
	 */
	...
	public Card(eSuit suit, eRank rank) {
		...
		/*
		 * this.Wild = false; this.CardImg = CardNbr + ".png";
		 */
	...
	/*
	 * public boolean getWild() { return this.Wild; }
	 * 
	 * public void setWild() { this.Wild = true; }
	 * 
